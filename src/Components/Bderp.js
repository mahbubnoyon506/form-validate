...
const Bderp = () => {
    ...
    let newCountry = country.toString();
    newCountry = typeof(newCountry)
    const serchByCountry = countryData?.filter((country) => country.country === ('bangladesh' || country));
    ...
    // console.log(newCountry, country, serchByCountry)
    ...
    return (
        <div className='bg-[#F9F9F9] py-10 px-5'>
            <div className='grid grid-cols-2 gap-5'>
                ...
                <div>
                    <h2 className='text-[#000] text-2xl font-semibold'>Shipping Address</h2>
                    <p className='cursor-pointer text-primary underline' onClick={handleShippingAddress}>Copy billing address</p>
                    <form>
                        <div className='pb-2'>
                            <label className='block text-[#000]' htmlFor="">Attention</label>
                            <input className='bg-[#fff] border-2 focus:outline-none pl-2 w-full' type="text" name="customername" id="name" value={shippingAddress?.name} />
                        </div>
                        <div className='pb-2'>
                            <label className='block text-[#000]' htmlFor="">Country</label>
                            <select
